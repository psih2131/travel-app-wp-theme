...
$config = array(
    ...
    'directionId'       => $term instanceof WP_Term ? (int) $term->term_id : 0,
    'heroTitle'         => $term instanceof WP_Term ? $term->name : '',
    'heroSub'           => $term instanceof WP_Term && $term->description ? $term->description : '',
    'breadcrumbCurrent' => $term instanceof WP_Term ? $term->name : '',
);
...
?>
<div id="travel-direction-tours-app"></div>
...
<script>window.travelDirectionToursConfig = <?php echo wp_json_encode( $config ); ?>;</script>
<script src="https://unpkg.com/vue@3/dist/vue.global.prod.js"></script>
<script src="<?php echo esc_url( $tpl ); ?>/assets/vue/TourCard.js"></script>
<script src="<?php echo esc_url( $tpl ); ?>/assets/vue/DirectionToursFilters.js"></script>
...
<script src="<?php echo esc_url( $tpl ); ?>/assets/js/direction-tours-script.js"></script>
