...
<div class="tour-info-sec__aside-org">
    ...
    <div class="tour-info-sec__aside-org-img-wrapper">
        ...
        <img src="<?php echo esc_url( $image['url'] ); ?>" alt="<?php echo esc_attr( $image['alt'] ?? $display_name ); ?>" class="tour-info-sec__aside-org-img">
    ...
    <div class="tour-info-sec__aside-org-data">
        ...
        <p class="tour-info-sec__aside-org-name">
            ...
            <a href="<?php echo esc_url( $guide_url ); ?>" class="tour-info-sec__aside-org-name-link"><?php echo esc_html( $display_name ); ?></a>

        </p>

        <p class="astour-info-sec__aside-org-subtitle">Организатор тура «<?php the_title(); ?>»</p>
